// nvcc -o matmul_dynamic_tile matmul_dynamic_tile.cu && ./matmul_dynamic_tile
// here we make the tile dynamic, the tile size is calculated based
// on the hardware specyfication not hardcodedd as before
