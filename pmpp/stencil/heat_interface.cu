...
nvcc -arch=sm_70 -O3 -std=c++11 -Xcompiler -Wall \
    -Xcompiler -fPIC -c stencil.cu -o stencil.o

nvcc -arch=sm_70 -O3 -std=c++11 -Xcompiler -Wall \
    -Xcompiler -fPIC \
    -c heat_interface.cu -o heat_interface.o

nvcc -arch=sm_70 -O3 -std=c++11 -Xcompiler -Wall \
    -shared -Xcompiler -fPIC \
    stencil.o heat_interface.o \
    -o libheat_cuda.so -lcudart
*/
